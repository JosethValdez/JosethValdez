...
- 🌱 Currently deepening my knowledge in **network emulation, LLM inference pipelines, and attacker behavior modeling**
...
### 🛡️ Sentinel — AI-Powered Malware Analysis Desktop App
> `React` · `Electron` · `Vite` · `Ollama` · `Python`

A Windows desktop app that catches malware by evaluating behavioral context — not just static signatures.
...
<span>
  ...
  <img src="https://img.shields.io/badge/Ncat-333333?style=for-the-badge&logo=gnu-bash&logoColor=white">
